 ...
 * Updated: Pablo Pazos, http://github.com/ppazos
...
;(function($, window, document, undefined){
  ...
  BootstrapPasswordStrengthMeter.prototype = {
    defaults: {
      minPasswordLength: 6,
      levelShortClassName: 'progress-bar-danger',
      levelShortDescription: 'Too short',
    ...
    processPassword: function() {
      ...
      if (currentPassword.length >= self.config.minPasswordLength) {
        ...
        progressBarWidth = 25;
        progressBar.addClass(this.config.levelShortClassName);
        progressBarDescription = this.config.levelShortDescription;
      } else {
        progressBarWidth = 0;
